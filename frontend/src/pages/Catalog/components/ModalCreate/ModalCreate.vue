...
<template>
  <div class="wrapper">
    <div class="content">
      <input type="text" placeholder="Workbook Name" v-model="name" />
    </div>

    <div class="control">
      <button
        class="control-btn control-btn-submit vb-font-primary-label-md"
        @click="
          () => {
      ...
      <button
        class="control-btn control-btn-cancel vb-font-primary-label-md"
